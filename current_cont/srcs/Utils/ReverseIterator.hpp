...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/12 15:03:39 by ijacquet          #+#    #+#             */
/*   Updated: 2021/11/12 15:03:40 by ijacquet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class reverse_iterator {
	...
	public:
		...
		{
			return reverse_iterator(_base.operator--(0));
		}
		...
		{
			return x.base().operator-(_base);
		}

		reverse_iterator	operator+(difference_type n) const
		{
			return reverse_iterator(_base.getValue() - n);
		}

		reverse_iterator	&operator+=(difference_type n)
		{
			_base.operator-=(n); return *this;
		}
...
reverse_iterator<Iterator>::reverse_iterator(const reverse_iterator<Iter> &x) : _base(x.base()) 
{
}
